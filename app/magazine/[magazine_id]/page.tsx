...
export default function MagazineDetailPage() {
  ...
  const id = clean(params?.magazine_id);
          ...
          <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, minWidth: 260 }}>
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 10, flexWrap: "wrap" }}>
                {mag?.AmazonURL ? (
                  <a href={mag.AmazonURL} target="_blank" rel="noreferrer" style={btnDark}>Amazon</a>
                ) : null}
                {mag?.電子版URL ? (
                  <a href={mag.電子版URL} target="_blank" rel="noreferrer" style={btnBlue}>電子版</a>
                ) : null}
              </div>
            </div>
          </div>
                    ...
                    {myPrizes.map((p, idx) => {
                      ...
                      return (
                        <article key={p.prize_id ?? idx} style={card}>
                          ...
                          {p.応募URL ? (
                            <a href={p.応募URL} target="_blank" rel="noreferrer" style={btnSmall}>WEB応募</a>
                          ) : null}
                        </article>
                      );
                    })}
